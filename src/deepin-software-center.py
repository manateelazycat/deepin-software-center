...
class FirstRun:
    ...
    def updateFinish(self):
        '''Update finish.'''
        # Update status.
        self.statusLabel.set_markup("<span size='%s'>%s</span>" % (LABEL_FONT_SIZE, "æ­£åœ¨æž„å»ºè½¯ä»¶åŒ…ç´¢å¼•"))
    ...
    def finish(self):
        '''Finish.'''
        # Update status.
        self.statusLabel.set_markup("<span size='%s'>%s</span>" % (LABEL_FONT_SIZE, "æ‰«æå®Œæ¯•!"))
